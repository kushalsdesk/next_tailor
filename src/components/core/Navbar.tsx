          ...
          >
            <div className="container mx-auto px-6 py-8 flex flex-col gap-6">
              ...
              {isAuthenticated ? (
                ...
                <div className="border-t border-border pt-4 pb-2 mt-2">
                  <Button onClick={() => { signInWithGoogle(); toggleMobileMenu(); }} variant="outline" className="w-full justify-center py-6 text-md font-semibold bg-white text-black border-gray-200 hover:bg-gray-50 rounded-xl shadow-sm">
